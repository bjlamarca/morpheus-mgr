import json, requests, traceback, time, threading, uuid
...
class HueBridgeUtils():
    ...
    def sync_device_types(self):
        ...
        signal.send(self.uuid, msg_dict, True)
    ...
    def sync_bridge_thread(self, bridge_id):
        try:
                hue_dev_types = HueDeviceTypes()
                device_added = False
                msg_dict = {}
                ...
                for device in bridge_devices:
                    ...
                    if device_obj:
                        ...
                        elif device_type.name == 'HUEDIMSWITCH':
                        ...
                        elif device_type.name == 'HUEBRIDGE':
                            new_device.save()
                            device_added = True
                            for service in services:
                                service_dict = dict(service)
